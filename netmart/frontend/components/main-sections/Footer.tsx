      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8">
          <div className="space-y-4">
            <h3 className={cn('text-2xl font-bold', ubuntu.className)}>
              Netmart
            </h3>
            <p className={cn('text-slate-300 max-w-sm', ubuntu.className)}>
              Modern websites and digital products designed to help your
              business grow with speed, style, and reliability.
            </p>
          </div>

          <div>
            <h4 className={cn('text-lg font-semibold mb-4', ubuntu.className)}>
              Quick Links
            </h4>
          ...
          <div className="space-y-4">
            <h4 className={cn('text-lg font-semibold', ubuntu.className)}>
              Get in Touch
            </h4>
            <a
              href="mailto:hello@netmart.se"
              className={cn(
                'inline-block text-slate-300 hover:text-white transition-colors',
                ubuntu.className,
              )}>
              hello@netmart.se
            </a>
            <div className="flex items-center gap-3">
              <a
                href="#"
                aria-label="Netmart on LinkedIn"
        ...
        <div className="mt-10 pt-6 border-t border-slate-800 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
          <p className={cn('text-sm text-slate-300', ubuntu.className)}>
            &copy; {new Date().getFullYear()} Netmart. All rights reserved.
          </p>
          <p className={cn('text-sm text-slate-300', ubuntu.className)}>
